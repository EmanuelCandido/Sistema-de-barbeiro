...
export interface Booking { id:string; dateKey:string; startTime:string; endTime:string; startAt:Timestamp; endAt:Timestamp; occupiedSlotKeys:string[]; serviceId:string; serviceNameSnapshot:string; durationMinutesSnapshot:number; priceCentsSnapshot:number; clientName:string; clientPhone:string; clientNote?:string; status:BookingStatus; paymentMethod?:PaymentMethod; lastCustomerMutation?:"create"|"cancel"|"reschedule"; createdByUid:string; createdAt:Timestamp; updatedAt:Timestamp }
export type ServiceIconKey="none"|"complete"|"scissors-comb"|"scissors"|"shaver"|"beard";
